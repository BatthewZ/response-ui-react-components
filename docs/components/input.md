...
removes the browser's own outline, which is why the ring has to be there — every native form
control in the library is keyed this way, and [Button](button.md) is not.
